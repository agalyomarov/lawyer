        ...
        <div class="col-12">
            ...
            <form method="post" action="{{ route('admin.article.update', $article->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control col-6" placeholder="" name="title" value="{{ $article->title }}">
                </div>
                <div class="form-group">
                    <label>Краткое описание</label>
                    <input type="text" class="form-control col-6" placeholder="" name="short_description" value="{{ $article->short_description }}">
                </div>
                <div class="form-group">
                    <label>Контент</label>
