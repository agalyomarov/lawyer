...
<body class="body customize-support" cz-shortcut-listen="true">
    ...
    <section class="bread">
        <div class="container">
            ...
            </span> / <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Перейти к Новости." href="{{ route('dost.index') }}" class="news-root post post-news"><span property="name">Достижения</span></a>
    ...
    <section class="home-six">
        ...
        <div class="container">
            @foreach ($dosts as $dost)
                <div class="home-six-item">
                    <a class="nounderline" href="{{ route('news.view', $dost->chpu) }}">
        ...
        {{ $dosts->links('pagination', compact('dosts')) }}
    </section>
