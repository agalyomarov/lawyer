...
<body class="body customize-support" cz-shortcut-listen="true">
    ...
    <section class="bread">
        <div class="container">
            ...
            </span> / <span property="itemListElement" typeof="ListItem"><span property="name" class="post post-news current-item">{{ $article->title }}</span>
                <meta property="url" content="{{ route('article.view', $article->chpu) }}/">
                <meta property="position" content="3">
            </span>
        </div>
    </section>
    <section class="home-one news-one" style="background: url({{ asset($article->image) }}) center center; background-size: cover;">
        <div class="container">
    ...
    <section class="home-six news-three">
        ...
        <div class="button-container">
            <a href="{{ route('article.index') }}/" class="button">Все статии</a>
        </div>
    </section>
